...
frame_1 = customtkinter.CTkFrame(master=app, corner_radius=10, width=1000)
frame_1.grid(row=0, column=1, sticky="nsew", pady=20, padx=20)
...
btn_check_tags.grid(row=4, column=1, pady=1, padx=50, sticky="w")
...
btn_fill_tags.grid(row=5, column=1, pady=1, padx=50, sticky="w")
