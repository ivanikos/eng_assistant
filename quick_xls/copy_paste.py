...
for key in item_list:
    print(key, "&", item_list[key][0], "&", item_list[key][1], "&", item_list[key][2], "&", item_list[key][3])
...
#
# wb = openpyxl.load_workbook(r"X:\55838\55838-07\06 - Pipe Support Engineering\6.03 - Non Advance Steel CAD Drawings\55838-07 support dwgs\BOM\SD-55838-07-018.xlsx")
# ws = wb["BOM"]
# print(file_name)
#
# for i in ws['A3':'C10']:
...
#         part_number_grade = str(i[2].value)
#         description = str(i[3].value)
#         item_weight = float(i[4].value)
#         total_weight = float(i[5].value)
#
